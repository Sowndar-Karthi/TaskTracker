...
function debugWhatIsBroken() {
  ...
  if (typeof SheetColumns === 'undefined') {
    ...
    lines.push('  6. Confirm all 24 .gs files exist in the project sidebar');
    ...
    lines.push('OK: SheetColumns and SheetColumns.RENEWAL look correct');
  }
  ...
  lines.push('');
  lines.push('Next step: run debugRunFullDiagnostics() for the full 24-file check.');
